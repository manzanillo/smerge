...
class ChangePasswordView(View):
    ...
    def post(self, request, proj_id):
        ...
        if new_password != None:
            ...
            if (
                actual_password and actual_password == old_password
            ) or actual_password == None:
...
class DeleteProjectView(View):
    ...
    def post(self, request, proj_id):
        ...
        if password != None:
            ...
            if (
                actual_password and actual_password == password
            ) or actual_password == None:
                proj.delete()
...
class ResetPasswordView(View):
    ...
    def post(self, request, token):
        ...
        proj.save()
        messages.success(request, _("Password changed"))
        return HttpResponseRedirect("/ext/project_view/" + str(proj.id))
