...
import { Box, Button, Divider, FormControl, IconButton, InputAdornment, InputLabel, MenuItem, OutlinedInput, Paper, Select, SelectChangeEvent, Stack, Tooltip } from "@mui/material";
...
const NewSettingControls: React.FC<NewSettingControlsProps> = ({projectId, changeLayout, initLayout = "preset", cy, saveGraphPositions}) => {
    ...
    return (
        <Paper elevation={6} style={{ background: "transparent", padding: "10px", borderRadius: "10px" }}>
            <Stack spacing={2}>
