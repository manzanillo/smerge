...
const Unlock: React.FC<UnlockProps> = () => {
    ...
    return (
        <Stack
            ...
            {initialLoad?
            <>
            <div style={{ width: "100px", height: "100px", padding: "20px", justifyContent: "center", justifyItems: "center" }}>
                <input ref={tmp} disabled={duringUnlock} id="inpLock" type="checkbox" value={(!locked)+""} defaultChecked onChange={onLockChange} />
            ...
            {remaining?<Countdown endTime={remaining} reloadOnEnd={true}/>:<></>}
            </>
            :<CircularProgress />}
        </Stack>
    )
